...
namespace StringDrop.Editor
{
	...
	public class StringListDrawer : PropertyDrawer
	{
		...
		private StringDropListAttribute _sdAttribute;

		public override void OnGUI(Rect position, SerializedProperty property, GUIContent label)
		{
			_sdAttribute ??= (StringDropListAttribute) attribute;
			var notEmpty = _sdAttribute.NotEmpty;
			var _currentIndex = -1;
			...
			CreateList(property, ref _currentIndex);
		...
		private void CreateList(SerializedProperty property, ref int _currentIndex)
		{
			_props.Clear();
			var targetType = _sdAttribute.Type;
			var checkAttribute = _sdAttribute.CheckAttribute;
